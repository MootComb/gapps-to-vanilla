...
copy_item "vanilla/priv-app/Provision"           "$WORK_DIR/system_ext/priv-app/Provision"           "Provision"
copy_item "vanilla/priv-app/StatementService"    "$WORK_DIR/system_ext/priv-app/StatementService"    "StatementService"
copy_item "vanilla/priv-app/ThemePicker"         "$WORK_DIR/system_ext/priv-app/ThemePicker"         "ThemePicker"
copy_item "vanilla/priv-app/Updater"             "$WORK_DIR/system_ext/priv-app/Updater"             "Updater"
echo ""
